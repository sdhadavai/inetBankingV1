...
public class Reporting extends TestListenerAdapter{
	...
	public void onStart(ITestContext testContext) {
		...
		htmlReporter.config().setReportName("Funcational Automation Test Report");//Name of Report
	...
	public void onTestSuccess(ITestResult tr) {
		 ...
		 logger.log(Status.PASS, MarkupHelper.createLabel(tr.getName(), ExtentColor.GREEN));//Send the passed info to report
	}
